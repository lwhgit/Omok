...
class Ai_cnn:
    ...
    def trainModel(self, Ai, omok):
        ...
        if(os.path.isfile(os.getcwd() + fileName + ".index") == True):
        ...
        while(True):
            epsilon = 0.1
            countWin = 0
            memory = replayMemory(10, 500, 0.9)
